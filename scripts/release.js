...
console.log(`🚀 Creating ${releaseType} release for WE Taxonomy Navigation...`);
...
try {
    ...
    console.log('   3. Create we-taxonomy-navigation.zip');
    ...
    console.log('   https://github.com/gbyat/we-taxonomy-navigation/actions');
    console.log('');
